...
import com.fruitstack.fruitstack.common.world.modifier.AddFeaturesByFilterBiomeModifier;
...
public class ModBiomeModifiers
{
	public static DeferredRegister<Codec<? extends BiomeModifier>> BIOME_MODIFIER_SERIALIZERS =
			DeferredRegister.create(ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, fruitstack.MODID);
