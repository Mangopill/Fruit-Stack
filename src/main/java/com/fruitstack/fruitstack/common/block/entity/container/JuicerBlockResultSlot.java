...
public class JuicerBlockResultSlot extends SlotItemHandler
{
	public final JuicerBlockEntity tileEntity;
	private final Player player;
	private int removeCount;

	public JuicerBlockResultSlot(Player player, JuicerBlockEntity tile, IItemHandler inventoryIn, int index, int xPosition, int yPosition) {
