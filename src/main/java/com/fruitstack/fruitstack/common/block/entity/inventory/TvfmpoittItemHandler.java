package com.fruitstack.fruitstack.common.block.entity.inventory;
...
public class TvfmpoittItemHandler implements IItemHandler
{
	private static final int SLOTS_INPUT = 8;
	private static final int SLOT_CONTAINER_INPUT = 9;
	private static final int SLOT_MEAL_OUTPUT = 10;
	private final IItemHandler itemHandler;
	private final Direction side;

	public TvfmpoittItemHandler(IItemHandler itemHandler, @Nullable Direction side) {
